...
{
    public class FakeNuixStreamFunctionFactory : RubyScriptStepFactory<FakeNuixStreamFunction, StringStream>
    {
        internal FakeNuixStreamFunctionFactory() { }
        public static RubyScriptStepFactory<FakeNuixStreamFunction, StringStream> Instance { get; } = new FakeNuixStreamFunctionFactory();
    ...
    {
        public override IRubyScriptStepFactory<StringStream> RubyScriptStepFactory => FakeNuixStreamFunctionFactory.Instance;
