...
def AddToCaseCompatibly(utilities,pathArg,folderNameArg,folderDescriptionArg,folderCustodianArg,filePathArg)
...
AddToCaseCompatibly(utilities, params[:pathArg0], params[:folderNameArg0], params[:folderDescriptionArg0], params[:folderCustodianArg0], params[:filePathArg0])
