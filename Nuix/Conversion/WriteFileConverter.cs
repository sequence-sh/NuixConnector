...
namespace Reductech.EDR.Connectors.Nuix.Conversion
{
    internal sealed class WriteFileConverter : CoreUnitMethodConverter<WriteFile>
    {
        ...
        public static readonly RubyFunctionParameter FolderParameter = new RubyFunctionParameter("folderArg", nameof(WriteFile.Folder), false, null);
        public static readonly RubyFunctionParameter FileNameParameter = new RubyFunctionParameter("fileNameArg",nameof(WriteFile.FileName), false, null);
        public static readonly RubyFunctionParameter TextParameter = new RubyFunctionParameter("textArg", nameof(WriteFile.Text),false, null);
